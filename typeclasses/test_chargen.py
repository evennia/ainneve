...
class ChargenTestCase(EvenniaTest):
    ...
    def test_node_start_over(self):
        ...
        self.assertEqual(self.char1.db.archetype, None)
        self.assertEqual(self.char1.db.race, None)
        self.assertEqual(self.char1.db.focus, None)
        self.assertEqual(self.char1.db.desc, None)
