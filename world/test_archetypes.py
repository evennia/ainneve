...
class ArchetypeTestCase(EvenniaTest):
    ...
    def test_apply_warrior(self):
        ...
        self.assertEqual(set(archetypes.ALL_TRAITS),
                         set(self.char1.traits.all))
        self.assertEqual(self.char1.traits.STR.value, 6)
        self.assertEqual(self.char1.traits.PER.value, 1)
        self.assertEqual(self.char1.traits.INT.value, 1)
        self.assertEqual(self.char1.traits.DEX.value, 4)
        self.assertEqual(self.char1.traits.CHA.value, 4)
        self.assertEqual(self.char1.traits.VIT.value, 6)
        self.assertEqual(self.char1.traits.MAG.value, 0)
    ...
    def test_apply_arcanist(self):
        ...
        self.assertEqual(set(archetypes.ALL_TRAITS),
                         set(self.char1.traits.all))
        self.assertEqual(self.char1.traits.STR.value, 1)
        self.assertEqual(self.char1.traits.PER.value, 4)
        self.assertEqual(self.char1.traits.INT.value, 6)
        self.assertEqual(self.char1.traits.DEX.value, 1)
        self.assertEqual(self.char1.traits.CHA.value, 4)
        self.assertEqual(self.char1.traits.VIT.value, 1)
        self.assertEqual(self.char1.traits.MAG.value, 6)
    ...
    def test_apply_warrior_scout(self):
        ...
        self.assertEqual(set(archetypes.ALL_TRAITS),
                         set(self.char1.traits.all))
        self.assertEqual(self.char1.traits.STR.value, 5)
        self.assertEqual(self.char1.traits.PER.value, 3)
        self.assertEqual(self.char1.traits.INT.value, 3)
        self.assertEqual(self.char1.traits.DEX.value, 4)
        self.assertEqual(self.char1.traits.CHA.value, 2)
        self.assertEqual(self.char1.traits.VIT.value, 3)
        self.assertEqual(self.char1.traits.MAG.value, 0)
    ...
    def test_apply_warrior_arcanist(self):
        ...
        self.assertEqual(set(archetypes.ALL_TRAITS),
                         set(self.char1.traits.all))
        self.assertEqual(self.char1.traits.STR.value, 3)
        self.assertEqual(self.char1.traits.PER.value, 2)
        self.assertEqual(self.char1.traits.INT.value, 3)
        self.assertEqual(self.char1.traits.DEX.value, 2)
        self.assertEqual(self.char1.traits.CHA.value, 4)
        self.assertEqual(self.char1.traits.VIT.value, 3)
        self.assertEqual(self.char1.traits.MAG.value, 3)
        # reset and test opposite order
    ...
    def test_apply_arcanist_scout(self):
        ...
        self.assertEqual(set(archetypes.ALL_TRAITS),
                         set(self.char1.traits.all))
        self.assertEqual(self.char1.traits.STR.value, 2)
        self.assertEqual(self.char1.traits.PER.value, 5)
        self.assertEqual(self.char1.traits.INT.value, 6)
        self.assertEqual(self.char1.traits.DEX.value, 2)
        self.assertEqual(self.char1.traits.CHA.value, 2)
        self.assertEqual(self.char1.traits.VIT.value, 1)
...
class PublicFunctionsTestCase(EvenniaTest):
    ...
    def test_valid_allocations(self):
        ...
        self.assertEqual(sum(self.char1.traits[t].value
    ...
    def test_calculate_secondary_traits(self):
        ...
        self.assertEqual(self.char1.traits.HP.value, 9)
        self.assertEqual(self.char1.traits.SP.value, 9)
        self.assertEqual(self.char1.traits.BM.value, 0)
        self.assertEqual(self.char1.traits.WM.value, 0)
        self.assertEqual(self.char1.traits.BM.max, 0)
        self.assertEqual(self.char1.traits.WM.max, 0)
        self.assertEqual(self.char1.traits.FORT.value, 9)
        self.assertEqual(self.char1.traits.REFL.value, 4)
        self.assertEqual(self.char1.traits.WILL.value, 1)
        self.assertEqual(self.char1.traits.ATKM.value, 9)
        self.assertEqual(self.char1.traits.ATKR.value, 1)
        self.assertEqual(self.char1.traits.ATKU.value, 6)
        self.assertEqual(self.char1.traits.DEF.value, 6)
