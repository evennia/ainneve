...
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-|C[ |rCharacter Info |C]|n-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-o
                                                                              ||
  |YName|n:  xxxxxxxxxxxxxAxxxxxxxxxxxxxx    |YXP|n: xxCxx / xxDxx        |YLevel|n: xEx  ||
  ...
  ooooooooooooooooooooooooooooooooooo  |                  |CIntelligence|n :xHxx  ||
                                       |                  |CDexterity|n    :xIxx  ||
  |YRace|n:           xxxxxxxxxxxYxxxxxxx  |                  |CCharisma|n     :xJxx  ||
  |YFocus|n:          xxxxxxxxxxxZxxxxxxx  |                  |CVitality|n     :xKxx  ||
